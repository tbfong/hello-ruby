...
puts "Currently it is #{weather_data[:current][:temperature]} degress and #{weather_data[:current][:conditions]}."
puts "Tomorrow it will be #{weather_data[:forecast][0][:temperature]}."
